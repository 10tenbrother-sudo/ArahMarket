    ...
    <div className={`w-full ${isModal ? 'max-w-5xl mx-auto' : 'max-w-6xl mx-auto py-8 px-4 sm:px-6'}`}>
      ...
      <div className="relative mb-8 text-center">
        ...
        <p className="text-sm text-slate-400 mt-2 max-w-xl mx-auto">
          Low-latency macroeconomic data, live G8 currency strength matrix, and AI-powered market drivers designed for professional macro traders.
        </p>
        ...
        <div className="mt-6 inline-flex items-center p-1 rounded-xl bg-slate-900 border border-slate-800">
          ...
          >
            ...
            <span className={`px-1.5 py-0.2 rounded text-[10px] uppercase tracking-wider font-extrabold ${
              billingCycle === 'annual' ? 'bg-slate-950 text-cyan-400' : 'bg-cyan-500/20 text-cyan-400'
            }`}>
              Save 20%
            </span>
          </button>
      ...
      {showComparison && (
        <div className="mt-8 rounded-2xl bg-slate-900/60 border border-slate-800 overflow-hidden font-sans text-xs">
          <div className="p-4 bg-slate-950 border-b border-slate-800 font-mono font-bold text-slate-200 flex items-center justify-between">
            ...
            <span className="text-xs text-slate-500 font-normal">Real-Time Telemetry & Access Rights</span>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-slate-800 bg-slate-900/80 font-mono text-[11px] text-slate-400">
                  ...
                  <th className="py-3 px-4 text-center">Evaluation (Free)</th>
                  <th className="py-3 px-4 text-center text-cyan-400 font-bold">Trader Pro ($49)</th>
                  <th className="py-3 px-4 text-center text-purple-400 font-bold">Institutional ($199)</th>
                </tr>
              </thead>
