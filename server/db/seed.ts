...
export function seedDatabase(): void {
  ...
  if (stats.sources_count === 0) {
    const sources: Source[] = [
      {
        id: 'src_tg_sm_news',
        name: 'Telegram: SM News 24',
        type: 'TELEGRAM',
        endpoint_url: 'https://t.me/s/SM_News_24',
        is_enabled: true,
        status: 'LIVE',
  ...
  // 3. Seed Telegram Channels
  if (stats.telegram_channels_count === 0) {
    const channels: TelegramChannel[] = [
      {
        id: 'tg_sm_news_24',
        handle: '@SM_News_24',
        title: 'SM News 24 Flash Wire',
        source_id: 'src_tg_sm_news',
        is_enabled: true,
        language: 'en',
